                    ...
                    <View style={{ height, width }}>
                        <View style={styles.innerContainer}>
                            <View>
                                ...
                                <TouchableOpacity><View style={styles.optionBox}>
                                ...
                                <TouchableOpacity><Text style={{ fontSize: 14, fontStyle: 'italic', textAlign: 'center', marginTop: 20, color: '#adb5bd' }}>Ich möchte erstmal so schauen</Text></TouchableOpacity>
                            </View>
                        </View>
                    </View>
                    <View style={{ height, width }}>
